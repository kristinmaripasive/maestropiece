...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { description: @art.description, name: @art.name, photo_url: @art.photo_url } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { description: @art.description, name: @art.name, photo_url: @art.photo_url } }
