...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { description: @music.description, name: @music.name, photo_url: @music.photo_url } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { description: @music.description, name: @music.name, photo_url: @music.photo_url } }
